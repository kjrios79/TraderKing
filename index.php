...
<html lang="es">
  ...
  <body>
    ...
    <header>
      ...
      <div class="logo">TRADERKING <span style="font-size:0.8rem; background:#f0b90b; color:#000; padding:2px 8px; border-radius:4px; font-weight:bold; margin-left:10px;">V3.1.96</span></div>
